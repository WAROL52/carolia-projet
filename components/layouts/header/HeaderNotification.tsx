...
export function HeaderNotification({}: HeaderNotificationProps) {
  const [openPopover, setOpenPopover] = React.useState(false);
  const onClose = useCallback(() => setOpenPopover(false), [setOpenPopover]);
  return (
    <Popover
      content={<NotificationMenu onClose={onClose} />}
      trigger={"click"}
...
function NotificationMenu({ onClose }: NotificationMenuProps) {
  return (
    <div
      className="me-3 overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl"
...
function ToutVoir({ onClose }: ToutVoirProps) {
